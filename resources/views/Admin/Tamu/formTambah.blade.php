...
@section('content')
    ...
    <div class="d-flex justify-content-center">
        <div class="card text-center">
            ...
            <div class="card-body">
                <form id="dataForm" action="{{ url('admin/simpan-data') }}" method="post" onsubmit="return validateForm()">
                    @csrf
