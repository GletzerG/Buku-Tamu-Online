...
<body>
	...
	<div class="limiter">
		<div class="container-login100" style="background-image: url({{url('/frontend/images/bg-01.jpg')}});">
			<div class="wrap-login100">
				<form class="login100-form validate-form">
					...
					<div class="wrap-input100 validate-input" data-validate = "Harap diisi">
						<input class="input100" type="text" name="username" placeholder="Nama">
						<span class="focus-input100" data-placeholder="&#xf207;"></span>
					</div>

					<div class="wrap-input100 validate-input" data-validate="Nama Instansi/Kantor">
						<input class="input100" type="text" name="pass" placeholder="Instansi/Kantor">
						<span class="focus-input100" data-placeholder="&#xf191;"></span>
					</div>
					...
					<div class="wrap-input100 validate-input" data-validate="Keperluan">
						<input class="input100" type="" name="pass" placeholder="Keperluan">
						<span class="focus-input100" data-placeholder="&#xf191;"></span>
					</div>
